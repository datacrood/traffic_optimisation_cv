...
class Main:
    ...
    liveVehicleCountCoods = (1100, 100)
    ...
    while True:
        ...
        # Display the live number of vehicles in the next lane
        def calculateLiveVehicleCount():
            live_count = 0
            for i in range(3):
                for vehicle in vehicles[directionNumbers[nextGreen]][i]:
                    if not vehicle.crossed:
                        live_count += 1
            return live_count

        liveVehicleCountCoods = (1100, 100)  
        liveVehicleCountText = font.render("Live Vehicles in Next Lane: " +
                                   str(calculateLiveVehicleCount()),
                                   True, (255, 255, 255), (0, 0, 0))
        screen.blit(liveVehicleCountText, liveVehicleCountCoods)
